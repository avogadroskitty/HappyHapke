...
self_ks = {'sml': np.array([1.57813825e-05, 1.55072622e-05, 1.51729805e-05, 1.47812784e-05,
...
#HERE IS WHERE I MAKE CHANGES FROM DIRTYHAPKEELI
#stuff from initialize...not dealing with that because we already have files loaded
phase_fn = 'legendre'
...
#already have a k from the preprocessed data so skipping solve_for_k
#more processing line 164 set up initial guesses
k = self_ks[guess_key]
