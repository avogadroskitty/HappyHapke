# -*- coding: utf-8 -*-
"""
Created on Thu Oct 11 14:16:10 2018
...
def initialize(phase_fn='legendre', scatter_type='lambertian', thetai=-30, thetae=0, n1=1.572, Bg=0,
               file1='', file2='', file3='', specwave_file='', calspec_file='',
               file4='', file5='', file6='', file7='', file8='', file9='', file10=''):  
...
def preprocess(low=0.32, high=2.55, UV=0.3, fit_order=1):
...
def solve_for_k(key='file2', b=0.1, c=0.3, ff=0.000000001, s=0, D=63):
...
def optimize_global_k(guess_key='file2', opt_strategy='slow',
                      lowb1=-1.71, lowb2=-1.72, lowb3=-1.73, upb1=1.71, upb2=1.72, upb3=1.73,
                      lowc1=-1.01, lowc2=-1.02, lowc3=-1.03, upc1=1.01, upc2=1.02, upc3=1.03,
                      lows1=0, lows2=0, lows3=0, ups1=0.061, ups2=0.062, ups3=0.063,
                      lowD1=21, lowD2=36, lowD3=50, upD1=106, upD2=150, upD3=180,
                      lowk=0, upk=0.1, num_solns=1, **kwargs):
