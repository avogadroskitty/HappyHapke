...
class ProgramState(object):
  def initialize(self, phase_fn='legendre', scatter_type='lambertian',
    ...
    self.ks = {}
    self.guesses = {}
    self.scat_eff_grain = {}#this is different
  ...
  def preprocess(self, low=0.32, high=2.55, UV=0.3, fit_order=1):
  ...
  def optimize_global_k(self, guess_key='file2', opt_strategy='slow',
                        ...
                        lowk=0, upk=0, num_solns=1, **kwargs):
    ...
    #Filling the rest of the array with the value of K
    print(self.ks)
    # set up bounds
